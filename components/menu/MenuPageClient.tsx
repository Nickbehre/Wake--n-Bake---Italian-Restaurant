...
export default function MenuPageClient({
  ...
  /** Server-side opgehaald menu, zodat de pagina direct (en voor Google) gevuld is */
  initialMenu?: MenuCategoryPayload[] | null;
}) {
  ...
  const [menuData, setMenuData] = useState<MenuCategoryPayload[] | null>(initialMenu);
  ...
  useEffect(() => {
    ...
    fetch('/api/products', { cache: 'no-store' })
      ...
      .then((data) => {
        ...
        else if (!initialMenu) setMenuError(true);
      })
      .catch(() => { if (!cancelled && !initialMenu) setMenuError(true); });
    return () => { cancelled = true; };
    // initialMenu is alleen de startwaarde; daarna ververst de client zelf
      ...
      <div className="container mx-auto px-4">
        ...
        <div id="schiacciata-menu" className="scroll-mt-40">
          ...
          <div className="space-y-24">
            {visibleSchiacciata.map((category) => (
