...
const translations: Record<Language, Record<string, string>> = {
  nl: {
    ...
    'hero.cta.takeaway': 'PICK-UP',

    // Story Section
    'story.headline': 'Van Italië naar de Vijzelstraat.',
    'story.subtext1': "Drie Italiaanse vrienden, één droom: de authentieke smaken van Italië naar Amsterdam brengen. Geen shortcuts, alleen tijd, passie en familiegeheimen.",
    ...
    'menuPage.added': 'Toegevoegd!',
    'menuPage.vegetarian': 'Vegetarisch',
    'menuPage.vegan': 'Vegan',
    'menuPage.spicy': 'Pittig',
    'menuPage.containsNuts': 'Bevat Noten',
    'menuPage.madeToOrder': 'Vers op bestelling',
    'menuPage.readyToGo': 'Klaar om mee te nemen',
    'menuPage.chooseSize': 'Kies formaat',
    'menuPage.viewToGoMenu': 'Bekijk To-Go Menu',
    'menuPage.schiacciatMenuTitle': 'Schiacciata Menu',
    'menuPage.schiacciatMenuSubtitle': 'Vers op bestelling gemaakt — kies regular of large',
    'menuPage.togoMenuTitle': "Wake N' Bake Menu",
    'menuPage.togoMenuSubtitle': 'Come taste the difference',
    ...
    'location.weekdays': 'Ma - Vr: 07:30 - 16:30',
    'location.saturday': 'Za: 08:00 - 18:00',
    'location.sunday': 'Zo: Gesloten',
    ...
    'reviews.rating': '5 sterren op basis van 200+ reviews',
    ...
    'contact.takeaway': 'Pick-up & Catering',
    ...
    'contact.cateringTitle': 'Catering & Evenementen',
    'contact.cateringDescription': 'Maak van elk evenement een succes met authentieke Italiaanse smaken! Wij verzorgen catering voor kantoorfeesten, verjaardagen, bedrijfsevenementen en meer. Van onze knapperige schiacciata tot zoete Italiaanse lekkernijen — wij brengen de smaken van Italië naar jouw locatie.',
    'contact.cateringCta': 'Vraag Catering Aan',
    'contact.cateringOptions': 'Wat wij aanbieden',
    'contact.cateringOffice': 'Kantoorlunches & Bedrijfsevenementen',
    'contact.cateringBirthday': 'Verjaardagen & Feesten',
    'contact.cateringPrivate': 'Privé Evenementen & Bijeenkomsten',
    ...
    'about.heroSubtitle': "Drie Italianen, één droom. Van Italië naar Amsterdam - ontdek de passie achter Wake N' Bake Panificio.",
    'about.storyTitle': 'Van Italië naar Amsterdam',
    'about.storyP1': "Het verhaal van Wake N' Bake begon toen drie vrienden uit Italië elkaar ontmoetten in Amsterdam. Elk van hen groeide op met de geur van vers gebakken brood - van nonnas die om 5 uur 's ochtends het deeg al kneedden, van familiefeesten waar de schiacciata nooit mocht ontbreken.",
    'about.storyP2': 'In Amsterdam vonden zij elkaar en deelden ze dezelfde droom: de authentieke smaken van Italië naar Nederland brengen. Niet zo lang geleden openden zij de deuren van Wake N\' Bake Panificio in de Vijzelstraat, met recepten die van generatie op generatie zijn doorgegeven.',
    'about.storyP3': 'Elke ochtend staan we vroeg op om vers deeg te kneden, precies zoals we het thuis hebben geleerd. We importeren onze bloem en ingrediënten rechtstreeks uit Italië. Geen haast, geen compromissen - alleen de echte Italiaanse smaak.',
    'about.valuesTitle': 'Waar Wij Voor Staan',
    'about.valueQuality': 'Kwaliteit',
    'about.valueQualityDesc': 'We gebruiken alleen de beste ingrediënten, rechtstreeks geïmporteerd uit Italië.',
    ...
    'about.teamP1': "Achter Wake N' Bake staan drie Italiaanse vrienden die hun passie voor authentiek Italiaans brood delen. Samen met ons team brengen we elke dag de smaken van Italië naar Amsterdam.",
    'about.teamP2': 'We geloven in een warme sfeer, precies zoals thuis in Italië. Kom gerust langs voor een praatje en proef waarom onze vaste klanten ons als hun tweede huiskamer zien.',
    ...
    'checkout.noSlotsText': 'Probeer het morgen opnieuw. Ma-Vr: 07:30-16:30, Za: 08:00-18:00',
    ...
    'checkout.errorPreparing': 'Er ging iets mis bij het voorbereiden van de betaling.',
    'checkout.errorConnection': 'Kon geen verbinding maken met de betaalservice. Probeer het later opnieuw.',
    'checkout.tryAgain': 'Probeer Opnieuw',
    'checkout.preparing': 'Betaling voorbereiden...',
    'checkout.nameLabel': 'Naam',
    'checkout.emailLabel': 'Email (voor bon)',
    'checkout.phoneLabel': 'Telefoonnummer',
    ...
    'checkout.payButton': 'Betaal & Bestel',
    'checkout.processingPayment': 'Verwerken...',
    'checkout.securePayment': 'Veilig betalen via Stripe',
    'checkout.selectPickupError': 'Selecteer a.u.b. een ophaaltijd.',
    'checkout.paymentFailed': 'Betaling mislukt. Probeer het opnieuw.',
    'checkout.paymentError': 'Er ging iets mis met de betaling.',
    'checkout.unexpectedError': 'Er is een onverwachte fout opgetreden.',
    'checkout.warning': 'Let op:',

    // Order Success
    'success.title': 'Grazie Mille!',
    'success.subtitle': 'Je bestelling is geslaagd.',
    'success.pickupDetails': 'Ophaal Details',
    'success.time': 'Tijdstip',
    'success.location': 'Locatie',
    ...
    'checkoutOptions.subtitle': 'Selecteer hoe je je bestelling wilt ontvangen',
    'checkoutOptions.orderSummary': 'Bestelling Overzicht',
    'checkoutOptions.deliveryTitle': 'Thuisbezorgd',
    'checkoutOptions.deliveryDescription': 'Bestel via Thuisbezorgd en laat je eten thuis bezorgen',
    'checkoutOptions.deliveryFeature1': 'Snelle bezorging naar jouw adres',
    'checkoutOptions.deliveryFeature2': 'Veilige online betaling',
    'checkoutOptions.deliveryFeature3': 'Volg je bestelling in real-time',
    'checkoutOptions.deliveryButton': 'Bestel via Thuisbezorgd',
    'checkoutOptions.collectTitle': 'Click & Collect',
    'checkoutOptions.collectDescription': 'Bestel online en haal op bij onze winkel',
    'checkoutOptions.collectFeature1': 'Haal op wanneer het jou uitkomt',
    'checkoutOptions.collectFeature2': 'Geen bezorgkosten',
    'checkoutOptions.collectFeature3': 'Betaal bij ophalen',
    'checkoutOptions.collectButton': 'Ga naar Checkout',
    'checkoutOptions.note': 'Let op: Voor Thuisbezorgd bestellingen word je doorgestuurd naar hun platform om je bestelling af te ronden. Je winkelwagen items staan hierboven ter referentie. Voor Click & Collect kun je je bestelling direct op onze site afronden.',
    'checkoutOptions.emptyCart': 'Je winkelwagen is leeg',
    'checkoutOptions.emptyCartText': 'Voeg eerst items toe aan je winkelwagen.',
    'checkoutOptions.backToMenu': 'Terug naar Menu',
  ...
  en: {
    ...
    'story.subtext1': "Three Italian friends, one dream: to bring the authentic flavors of Italy to Amsterdam. No shortcuts, just time, passion and family secrets.",
    ...
    'menuPage.added': 'Added!',
    'menuPage.vegetarian': 'Vegetarian',
    'menuPage.vegan': 'Vegan',
    'menuPage.spicy': 'Spicy',
    'menuPage.containsNuts': 'Contains Nuts',
    'menuPage.madeToOrder': 'Made fresh to order',
    'menuPage.readyToGo': 'Ready to go',
    'menuPage.chooseSize': 'Choose size',
    'menuPage.viewToGoMenu': 'View To-Go Menu',
    'menuPage.schiacciatMenuTitle': 'Schiacciata Menu',
    'menuPage.schiacciatMenuSubtitle': 'Made fresh to order — choose regular or large',
    'menuPage.togoMenuTitle': "Wake N' Bake Menu",
    'menuPage.togoMenuSubtitle': 'Come taste the difference',
    ...
    'location.weekdays': 'Mon - Fri: 07:30 - 16:30',
    'location.saturday': 'Sat: 08:00 - 18:00',
    'location.sunday': 'Sun: Closed',
    ...
    'reviews.rating': '5 stars based on 200+ reviews',
    ...
    'contact.cateringTitle': 'Catering & Events',
    'contact.cateringDescription': 'Make every event a success with authentic Italian flavors! We provide catering for office parties, birthdays, corporate events and more. From our crispy schiacciata to sweet Italian treats — we bring the flavors of Italy to your location.',
    'contact.cateringCta': 'Request Catering',
    'contact.cateringOptions': 'What we offer',
    'contact.cateringOffice': 'Office Lunches & Corporate Events',
    'contact.cateringBirthday': 'Birthdays & Celebrations',
    'contact.cateringPrivate': 'Private Events & Gatherings',
    ...
    'about.heroSubtitle': "Three Italians, one dream. From Italy to Amsterdam - discover the passion behind Wake N' Bake Panificio.",
    'about.storyTitle': 'From Italy to Amsterdam',
    'about.storyP1': "The story of Wake N' Bake began when three friends from Italy met each other in Amsterdam. Each of them grew up with the smell of freshly baked bread - from nonnas who were already kneading dough at 5 in the morning, from family celebrations where schiacciata was never missing.",
    'about.storyP2': 'In Amsterdam, they found each other and shared the same dream: to bring the authentic flavors of Italy to the Netherlands. Not so long ago, they opened the doors of Wake N\' Bake Panificio on the Vijzelstraat, with recipes passed down from generation to generation.',
    'about.storyP3': 'Every morning we get up early to knead fresh dough, just as we learned at home. We import our flour and ingredients directly from Italy. No rush, no compromises - just the real Italian taste.',
    'about.valuesTitle': 'What We Stand For',
    'about.valueQuality': 'Quality',
    'about.valueQualityDesc': 'We only use the finest ingredients, imported directly from Italy.',
    ...
    'about.teamP1': "Behind Wake N' Bake are three Italian friends who share their passion for authentic Italian bread. Together with our team, we bring the flavors of Italy to Amsterdam every day.",
    'about.teamP2': 'We believe in a warm atmosphere, just like home in Italy. Feel free to stop by for a chat and taste why our regular customers see us as their second living room.',
    ...
    'checkout.noSlotsText': 'Please try again tomorrow. Mon-Fri: 7:30 AM-4:30 PM, Sat: 8:00 AM-6:00 PM',
    ...
    'checkout.errorPreparing': 'Something went wrong while preparing the payment.',
    'checkout.errorConnection': 'Could not connect to the payment service. Please try again later.',
    'checkout.tryAgain': 'Try Again',
    'checkout.preparing': 'Preparing payment...',
    'checkout.nameLabel': 'Name',
    'checkout.emailLabel': 'Email (for receipt)',
    ...
    'checkout.payButton': 'Pay & Order',
    'checkout.processingPayment': 'Processing...',
    'checkout.securePayment': 'Secure payment via Stripe',
    'checkout.selectPickupError': 'Please select a pickup time.',
    'checkout.paymentFailed': 'Payment failed. Please try again.',
    'checkout.paymentError': 'Something went wrong with the payment.',
    'checkout.unexpectedError': 'An unexpected error occurred.',
    'checkout.warning': 'Note:',

    // Order Success
    'success.title': 'Grazie Mille!',
    'success.subtitle': 'Your order was successful.',
    'success.pickupDetails': 'Pickup Details',
    'success.time': 'Time',
    ...
    'checkoutOptions.subtitle': 'Select how you would like to receive your order',
    'checkoutOptions.orderSummary': 'Order Summary',
    'checkoutOptions.deliveryTitle': 'Home Delivery',
    'checkoutOptions.deliveryDescription': 'Order via Thuisbezorgd and have your food delivered to your door',
    'checkoutOptions.deliveryFeature1': 'Fast delivery to your address',
    'checkoutOptions.deliveryFeature2': 'Secure online payment',
    'checkoutOptions.deliveryFeature3': 'Track your order in real-time',
    'checkoutOptions.deliveryButton': 'Order via Thuisbezorgd',
    'checkoutOptions.collectTitle': 'Click & Collect',
    'checkoutOptions.collectDescription': 'Order online and pick up at our store',
    'checkoutOptions.collectFeature1': 'Pick up at your convenience',
    'checkoutOptions.collectFeature2': 'No delivery fees',
    'checkoutOptions.collectFeature3': 'Pay when you pick up',
    'checkoutOptions.collectButton': 'Continue to Checkout',
    'checkoutOptions.note': 'Note: For Thuisbezorgd orders, you\'ll be redirected to their platform to complete your order. Your cart items are shown above for reference. For Click & Collect, you can complete your order directly on our site.',
    'checkoutOptions.emptyCart': 'Your Cart is Empty',
    'checkoutOptions.emptyCartText': 'Add some items to your cart before checking out.',
