...
const translations: Record<Language, Record<string, string>> = {
  nl: {
    ...
    'about.heroSubtitle': "Van een kleine bakkerij in Toscane naar het hart van Amsterdam. Ontdek de passie achter Wake N' Bake Panificio.",
    'about.storyTitle': 'De Droom Begon in Italië',
    'about.storyP1': "Het verhaal van Wake N' Bake begon in een kleine bakkerij in de heuvels van Toscane. Daar leerde onze oprichter de kunst van het broodbakken van zijn grootmoeder - de geheimen van het perfecte deeg, het belang van geduld en de magie van verse ingrediënten.",
    'about.storyP2': 'In 2019 brachten we deze Italiaanse traditie naar Amsterdam. Met dezelfde passie en dezelfde recepten als in Italië, maar met een moderne twist. Het resultaat? De knapperigste schiacciata en de luchtigste focaccia van de stad.',
    'about.storyP3': 'Elke ochtend staan we vroeg op om vers deeg te kneden. We importeren onze bloem rechtstreeks uit Italië en werken alleen met de beste lokale producten. Geen haast, geen compromissen - alleen puur vakmanschap.',
    'about.valuesTitle': 'Waar Wij Voor Staan',
    'about.valueQuality': 'Kwaliteit',
    'about.valueQualityDesc': 'We gebruiken alleen de beste ingrediënten, van Italiaanse bloem tot verse lokale producten.',
    'about.valuePassion': 'Passie',
    'about.valuePassionDesc': 'Elke dag staan we met liefde in de keuken om de perfecte focaccia te maken.',
    'about.valueAuthenticity': 'Authenticiteit',
    'about.valueAuthenticityDesc': 'Onze recepten zijn overgeleverd van generatie op generatie uit Italië.',
    ...
    'about.teamP1': "Achter elke focaccia staat een team van gepassioneerde bakkers en barista's. Van onze hoofdbakker Marco, die al 20 jaar brood bakt, tot onze jonge medewerkers die de traditie voortzetten.",
    'about.teamP2': 'We geloven in een warme sfeer, zowel in onze keuken als in onze winkel. Kom gerust langs voor een praatje en ontdek waarom onze vaste klanten ons als hun tweede huiskamer zien.',
  ...
  en: {
    ...
    'about.heroSubtitle': "From a small bakery in Tuscany to the heart of Amsterdam. Discover the passion behind Wake N' Bake Panificio.",
    'about.storyTitle': 'The Dream Started in Italy',
    'about.storyP1': "The story of Wake N' Bake began in a small bakery in the hills of Tuscany. There, our founder learned the art of bread baking from his grandmother - the secrets of the perfect dough, the importance of patience, and the magic of fresh ingredients.",
    'about.storyP2': 'In 2019, we brought this Italian tradition to Amsterdam. With the same passion and recipes as in Italy, but with a modern twist. The result? The crispiest schiacciata and the fluffiest focaccia in the city.',
    'about.storyP3': 'Every morning we get up early to knead fresh dough. We import our flour directly from Italy and only work with the best local products. No rush, no compromises - just pure craftsmanship.',
    'about.valuesTitle': 'What We Stand For',
    'about.valueQuality': 'Quality',
    'about.valueQualityDesc': 'We only use the finest ingredients, from Italian flour to fresh local products.',
    'about.valuePassion': 'Passion',
    'about.valuePassionDesc': 'Every day we stand in the kitchen with love to make the perfect focaccia.',
    'about.valueAuthenticity': 'Authenticity',
    'about.valueAuthenticityDesc': 'Our recipes have been passed down from generation to generation from Italy.',
    ...
    'about.teamP1': "Behind every focaccia is a team of passionate bakers and baristas. From our head baker Marco, who has been baking bread for 20 years, to our young staff who continue the tradition.",
    'about.teamP2': 'We believe in a warm atmosphere, both in our kitchen and in our shop. Feel free to stop by for a chat and discover why our regular customers see us as their second living room.',
