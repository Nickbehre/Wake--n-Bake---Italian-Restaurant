...
const porkSchiacciata: Category = {
  ...
  products: [
    ...
    },
    {
      ...
      name: 'Salame Vesuvio',
      description: "Ventricina, burrata stracciatella, n'duja, roasted peppers, rocket, balsamic glaze.",
      price: 13.00,
      hasSizes: true,
      priceRegular: 9.00,
      priceLarge: 13.00,
    ...
    },
    {
      ...
      description: 'Prosciutto San Daniele, buffalo mozzarella, cherry tomatoes, rocket, balsamic glaze, EVO.',
      price: 13.00,
      hasSizes: true,
      priceRegular: 9.00,
      priceLarge: 13.00,
    ...
    {
      id: 'schiacciata-prosciutto-parmigiana',
      name: 'Prosciutto Parmigiana',
      description: 'Prosciutto San Daniele, parmesan creme, roasted eggplant, parmesan, rocket, EVO.',
      price: 13.00,
      hasSizes: true,
      priceRegular: 9.00,
      priceLarge: 13.00,
    ...
    },
    {
      ...
      description: 'Roasted pork, roasted potatoes, caramelised onions, pistachio mayonnaise, rocket, crumbled pistachios, EVO.',
      price: 15.00,
      hasSizes: true,
      priceRegular: 11.00,
      priceLarge: 15.00,
